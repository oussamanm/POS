...
class PurchasesReturnController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        \DB::transaction(function () use ($request) {
            ...
            $purchase_return->Ref = $this->getNumberOrder();
            $purchase_return->purchase_id = $request->purchase_id;
            $purchase_return->provider_id = $request->supplier_id;
            $purchase_return->warehouse_id = $request->warehouse_id;
            $purchase_return->tax_rate = $request->tax_rate;
            $purchase_return->TaxNet = $request->TaxNet;
            $purchase_return->discount = $request->discount;
            $purchase_return->shipping = $request->shipping;
            $purchase_return->statut = $request->statut;
            $purchase_return->GrandTotal = $request->GrandTotal;
            $purchase_return->payment_statut = 'unpaid';
            ...
            foreach ($data as $key => $value) {
                ...
                // check if compoleted to decrease quantity from warehouse
                if ($purchase_return->statut == "completed")
                {
    ...
    public function edit(Request $request , $id)
    {
     ...
     public function new_create_purchase_return(Request $request , $id)
     {
         $this->authorizeForUser($request->user('api'), 'create', PurchaseReturn::class);
         ...
         $Return_detail['purchase_id'] = "";
         $Return_detail['purchase_ref'] = "";
    ...
    public function Return_pdf(Request $request, $id)
    {
        ...
        // return $pdf->stream('Purchase_Return.pdf');
