            ...
            <b-col md="6" sm="12">
                <b-form-group label="Vendeurs">
                  <v-select
                    ...
                    :options="vendors.map(vendor => ({label: vendor.firstname + ' ' + vendor.lastname, value: vendor.id}))"
                  />
                </b-form-group>
            </b-col>
          ...
          <table class="table table-striped table-md">
            <tbody>
              ...
              <tr>
                ...
                <th>
                    <button @click="redirectToMap">Ouvrir dans Google Maps</button>
                </th>
  ...
  methods: {
    ...
    redirectToMap() {
        ...
        else
        {
            this.makeToast(
                "warning",
                "La Localisation de ce Client n'est pas Enregistrée",
                this.$t("Warning")
            );
        }
    },
    ...
    Edit_Client(client) {
      ...
      console.log(">>>>>>", client)
      if (client.user)
        this.client.user_id = client.user.id
      this.editmode = true;
      this.$bvModal.show("New_Customer");
    },
