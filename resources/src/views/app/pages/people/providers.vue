          ...
          <span v-if="props.column.field == 'actions'">
            <div>
              ...
              >
                ...
                <b-dropdown-item :to="'/app/reports/detail_supplier/'+props.row.id"
                >
                  <i class="nav-icon i-Dollar font-weight-bold mr-2"></i>
                  {{$t('Rapport de fournisseur')}}
                </b-dropdown-item>
  ...
  methods: {
    ...
    Providers_PDF() {
      ...
      let columns = [
        ...
        { title: "Tel", dataKey: "phone" },
        { title: "Achat dû", dataKey: "due" },
        { title: "Retour d'achat", dataKey: "return_Due" },
        { title: "TVA", dataKey: "tax_number" },
        { title: "Email", dataKey: "email" },
        { title: "Ville", dataKey: "city" },
      ];
      pdf.autoTable(columns, self.providers);
      pdf.text("Liste des Fournisseurs", 40, 25);
