            ...
            <b-card class="mt-3">
              <b-row>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider
                    name="ArNom"
                    :rules="{required:false , min:3 , max:55}"
                    v-slot="validationContext"
                  >
                    <b-form-group :label="$t('Nom (Arabe)')">
                      <b-form-input
                        :state="getValidationState(validationContext)"
                        aria-describedby="Ar-name-feedback"
                        label="Nom (Arabe)"
                        :placeholder="$t('Nom (Arabe)')"
                        v-model="product.ar_name"
                        dir="rtl"
                      ></b-form-input>
                      <b-form-invalid-feedback id="Ar-name-feedback">{{ validationContext.errors[0] }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                </b-col>
              ...
              <b-row>
                  ...
                  <validation-provider name="Type" :rules="{ required: true}">
                    <b-form-group slot-scope="{ valid, errors }" :label="$t('type') + ' ' + '*'">
                      <v-select
                        ...
                        :options="
                            [
                            {label: $t('Standard_Product'), value: 'is_single'},
                            {label: $t('Variable_Product'), value: 'is_variant'}
                            ]"
                      ></v-select>
                      <b-form-invalid-feedback>{{ errors[0] }}</b-form-invalid-feedback>
                    </b-form-group>
                ...
                >
                  <validation-provider
                    ...
                    v-slot="validationContext"
                  >
                    <b-form-group :label="$t('ProductMinPrice') + ' ' + '*'">
                      <b-form-input
                        :state="getValidationState(validationContext)"
                        aria-describedby="ProductPrice-feedback"
                        label="Price"
                        :placeholder="$t('Enter_Product_Min_Price')"
