...
export default {
  ...
  methods: {
    ...
    Product_PDF() {
      ...
      let columns = [
        // { title: this.$t('Type'), dataKey: "type" },
        { title: this.$t('Name'), dataKey: "name" },
        { title: this.$t('Code'), dataKey: "code" },
        { title: this.$t('Category'), dataKey: "category" },
        { title: this.$t('Cost'), dataKey: "cost" },
        { title: this.$t('Price'), dataKey: "price" },
        { title: this.$t('Unit'), dataKey: "unit" },
