                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        >
                              ...
                              <b-input-group>
                                <b-input-group-prepend>
                                  <span
                                    ...
                                    @click="decrement(detail ,detail.id)"
                                  >-</span>
                                </b-input-group-prepend>
                                <input
                                  class="form-control"
                                  @keyup="Verified_Qty(detail,detail.id)"
                                  :min="0.00"
                                ...
                                <b-input-group-append>
                                  <span
                                    class="btn btn-primary btn-sm"
                                    @click="increment(detail ,detail.id)"
                                  >+</span>
                                </b-input-group-append>
                              </b-input-group>
                            </div>
                          ...
                          <td>
                              {{currentUser.currency}} {{formatNumber(detail.quantity * detail.price, 3)}}
                          </td>
...
export default {
  ...
  methods: {
    ...
    //-----------------------------------increment QTY ------------------------------\\
     ...
     increment(detail, id) {
      console.log(detail, id, this.details)
      for (var i = 0; i < this.details.length; i++) {
    ...
    GetElements() {
      ...
      axios
        .get(`returns/sale/edit_sell_return/${id}/null`)
        .then(response => {
