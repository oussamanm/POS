                ...
                <b-row>
                    ...
                    <b-col md="12">
                        <b-form-group :label="$t('Expense_Category')">
                            <v-select
                                :reduce="(label) => label.value"
                                :placeholder="$t('Choisir Catégorie')"
    ...
    methods: {
        ...
        Expense_PDF() {
            ...
            let columns = [
                ...
                { title: "Magasin & Vendeur", dataKey: "warehouse_name" },
                { title: this.$t("Details"), dataKey: "details" },
                { title: this.$t("Reference"), dataKey: "Ref" },
                { title: this.$t("Amount"), dataKey: "amount" },
                { title: "Catégorie", dataKey: "category_name" },
            ];
            pdf.autoTable(columns, self.expenses);
            pdf.text("Liste des dépenses", 40, 25);
