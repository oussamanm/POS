          ...
          <b-col lg="12" md="12" sm="12">
            <b-card>
              <b-row>
                  ...
                  <table class="table table-striped table-sm">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>{{currentUser.currency}} {{TaxTotal.toFixed(2)}}</span>
                        </td>
                      </tr>
                      <tr>
                ...
                <!-- Order Tax  -->
                <b-col lg="4" md="4" sm="12" class="mb-3 d-none" v-if="currentUserPermissions && currentUserPermissions.includes('edit_tax_discount_shipping_quotation')">
                  <validation-provider
                    name="Order Tax"
                    :rules="{ regex: /^\d*\.?\d*$/}"
                    v-slot="validationContext"
        ...
        <b-form @submit.prevent="submit_Update_Detail">
          <b-row>
            ...
            <b-col lg="6" md="6" sm="12">
             ...
             <!-- Unit Sale -->
             <b-col class="d-none" lg="6" md="6" sm="12" v-if="detail.product_type != 'is_service'">
  ...
  methods: {
   ...
   // Search Products
    ...
    add_product()
    {
        ...
        console.log("---------- Prd Pushed : ", this.product);
    ...
    taxer() {
        ...
        for (var ii = 0; ii < this.details.length; ii++) {
            this.TaxTotal += (this.details[ii].taxe * this.details[ii].quantity)
        }
    },
    //---------- keyup OrderTax
    keyup_OrderTax() {
