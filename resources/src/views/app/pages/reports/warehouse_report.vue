    ...
    <b-row v-if="!isLoading">
      ...
      <b-col lg="3" md="6" sm="12">
        <b-card class="card-icon-bg card-icon-bg-primary o-hidden mb-30 text-center">
          <i class="i-Full-Cart"></i>
          <div class="content">
            <p class="text-muted mt-2 mb-0">Ventes en DH</p>
            <p class="text-primary text-24 line-height-1 mb-2">{{total.totalSales}}</p>
          </div>
        </b-card>
      </b-col>
      <b-col lg="3" md="6" sm="12">
...
export default {
  ...
  methods: {
    ...
    Get_Reports() {
      axios
        .get("report/warehouse_report?warehouse_id=" + (this.Filter_warehouse == "" ? "1" : this.Filter_warehouse))
        .then(response => {
        ...
        .then(response => {
          ...
          this.Stock_Count = {
            ...
            tooltip: {
              ...
              formatter: function(params) {
                return `(${params.value} Articles)<br />
                        (${params.data.value1} Quantité)`;
              }
            },
            legend: {
              orient: "vertical",
          ...
          this.Stock_value = {
            ...
            tooltip: {
              ...
              backgroundColor: "rgba(0, 0, 0, .8)",
              formatter: function(params) {
                return `(Stock Valeur par Prix : ${params.value})<br />
                        (Stock Valeur par Coût : ${params.data.value1})`;
