  ...
  methods: {
    ...
    Payment_PDF() {
      ...
      let columns = [
        ...
        { title: this.$t("Purchase"), dataKey: "Ref_Purchase" },
        { title: this.$t("Supplier"), dataKey: "provider_name" },
      ...
      // Add the summary label with the total amount
      pdf.text("Paiements Liste des achats", 40, 25);
      pdf.setFontSize(15);
      pdf.text(`Total des Paiements des Achats: ${totalAmount} DH`, 40, pdf.autoTable.previous.finalY + 50); // Adjust the Y position as needed
    
      pdf.save("Paiements_Liste_des_achats.pdf");
    },
