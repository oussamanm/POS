...
export default {
    ...
    Choose_Category: 'Choisissez le fournisseur',
    ...
    Enter_Product_Min_Price: 'Entrez le prix min de vente',
    ...
    Enter_name_category: 'Entrez le nom de fournisseur',
    Enter_Code_category: 'Entrez le code de fournisseur',
    ...
    Dernierescinqrecords: 'Dernières cinq records',
    Filters: 'Filtres',
    date: 'Date',
    Reference: 'Référence',
    Ref: 'Réf',
    ...
    ProductMinPrice: 'Prix Min de vente',
    ...
    ListQuotations: 'Liste des devis',
    ...
    Delete: {
        ...
        CatDeleted: 'Cette Fournisseur a été supprimé',
    ...
    Update: {
        ...
        TitleCat: 'Fournisseur mis à jour avec succès',
    ...
    Create: {
        ...
        TitleCat: 'Fournisseur créé  avec succès',
    ...
    Codecategorie: 'Code Fournisseur',
    Namecategorie: 'Nom de Fournisseur',
    ...
    ReturnDashboard: 'Retour au tableau de bord',
     ...
     Created_in_successfully:'Créé avec succès',
     Updated_in_successfully:'Mis à jour avec succès',
     Deleted_in_successfully:'Supprimé avec succès',
    ...
    Create_Quotation_with_Stock: 'Créer un devis à partir du stock',
    ...
    ListInventries: 'Liste des Inventaires',
