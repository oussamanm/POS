...
const routes = [
    {
        ...
        children: [
            ...
            //inventory
            {
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "inventory" */ "./views/app/pages/inventory"
                    ),
                redirect: "/app/inventory/list",
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "index_inventory" */
                                "./views/app/pages/inventory/index_inventory"
                            )
                    },
                    {
                        name: "edit_inventory",
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "edit_inventory" */
                                "./views/app/pages/inventory/edit_inventory"
                            )
                    }
                ]
            },
            ...
            //Stock Assignment
            {
                path: "/app/stock_assignment",
                component: () =>
                    import(
                        /* webpackChunkName: "stock_assignment" */ "./views/app/pages/stock_assignment"
                    ),
                redirect: "/app/stock_assignment/list",
                children: [
                    {
                        name: "index_stock_assignment",
                        path: "list",
                        component: () =>
                            import(
                                /* webpackChunkName: "index_stock_assignment" */ "./views/app/pages/stock_assignment/index_stock_assignment"
                            )
                    },
                    {
                        name: "store_stock_assignment",
                        path: "store",
                        component: () =>
                            import(
                                /* webpackChunkName: "store_stock_assignment" */
                                "./views/app/pages/stock_assignment/create_stock_assignment"
                            )
                    },
                    {
                        name: "edit_stock_assignment",
                        path: "edit/:id",
                        component: () =>
                            import(
                                /* webpackChunkName: "edit_stock_assignment" */ "./views/app/pages/stock_assignment/edit_stock_assignment"
                            )
                    }
                ]
            },
            ...
            //Purchase
            {
                ...
                children: [
                    ...
                    {
                        name: "purchases_payment",
                        path: "purchases_payment",
                        component: () =>
                            import(
                                /* webpackChunkName: "create_purchase_return" */ "./views/app/pages/purchases/purchases_payment"
                            )
                    },
                    {
                        name: "edit_purchase",
                    ...
                    {
                        name: "new_purchase_return",
                        path: "new_purchase_return",
                        component: () =>
                            import(
                                /* webpackChunkName: "create_purchase_return" */ "./views/app/pages/purchase_return/new_create_purchase_return"
                            )
                    },
                    {
            ...
            //Sale
            {
                ...
                children: [
                    ...
                    {
                        name: "new_sale_return",
                        path: "new_sale_return",
                        component: () =>
                            import(
                                /* webpackChunkName: "create_sale_return" */ "./views/app/pages/sale_return/new_create_sale_return"
                            )
                    },
                    {
                        name: "detail_sale",
            ...
            // Sales Return
            {
                ...
                children: [
                    ...
                    {
                        name: "new_edit_sale_return",
                        path: "edit/:id",
                        component: () =>
                            import(
                                /* webpackChunkName: "new_edit_sale_return" */
                                "./views/app/pages/sale_return/new_edit_sale_return"
                            )
                    },
                    {
