<template>
    <div class="side-content-wrap" @mouseenter="isMenuOver = true" @mouseleave="isMenuOver = false"
        ...
        <vue-perfect-scrollbar :settings="{ suppressScrollX: true, wheelPropagation: false }"
            ...
            <div>
                <ul class="navigation-left">
                    <li @mouseenter="toggleSubMenu" :class="{ active: selectedParentMenu == 'dashboard' }"
                        class="nav-item" data-item="dashboard">
                        <router-link tag="a" class="nav-item-hold" to="/app/dashboard">
                            <i class="nav-icon i-Bar-Chart"></i>
                            <span class="nav-text">{{ $t("dashboard") }}</span>
                        </router-link>
                    </li>
                    <li v-show="currentUserPermissions
                        && (currentUserPermissions.includes('products_add')
                            ...
                            || currentUserPermissions.includes('category'))" @mouseenter="toggleSubMenu" class="nav-item"
                        :class="{ active: selectedParentMenu == 'products' }" data-item="products" :data-submenu="true">
                        <a v-if="!isMobile" class="nav-item-hold" tag="a" href="/app/products/list">
                            <i class="nav-icon i-Library-2"></i>
                            <span class="nav-text">{{ $t('Products') }}</span>
                        </a>
                        <a v-else class="nav-item-hold" href="#">
                            <i class="nav-icon i-Library-2"></i>
                            <span class="nav-text">{{ $t('Products') }}</span>
                        </a>
                    ...
                    <li v-show="currentUserPermissions
                        && (currentUserPermissions.includes('adjustment_view')
                            || currentUserPermissions.includes('adjustment_add'))" @mouseenter="toggleSubMenu" class="nav-item"
                        :class="{ active: selectedParentMenu == 'adjustments' }" data-item="adjustments"
                        :data-submenu="true">
                        <a v-if="!isMobile" class="nav-item-hold" tag="a" href="/app/adjustments/list">
                    ...
                    <li v-show="currentUserPermissions && (currentUserPermissions.includes('stock_assignment_view')
                        || currentUserPermissions.includes('stock_assignment_add'))" @mouseenter="toggleSubMenu"
                        class="nav-item" :class="{ active: selectedParentMenu == 'stock_assignment' }"
                        data-item="stock_assignment" :data-submenu="true">
                        <a v-if="!isMobile" class="nav-item-hold" tag="a" href="/app/stock_assignment/list">
                            <i class="nav-icon i-Back"></i>
                            <span class="nav-text">Affectation de stock</span>
                        </a>
                        <a v-else class="nav-item-hold" href="#">
                            <i class="nav-icon i-Back"></i>
                            <span class="nav-text">Affectation de stock</span>
                    ...
                    <li v-show="currentUserPermissions && (currentUserPermissions.includes('Quotations_view')
                        || currentUserPermissions.includes('Quotations_add'))" @mouseenter="toggleSubMenu"
                        class="nav-item" :class="{ active: selectedParentMenu == 'quotations' }" data-item="quotations"
                        :data-submenu="true">
                        <a v-if="!isMobile" class="nav-item-hold" tag="a" href="/app/quotations/list">
                    ...
                    <li v-show="currentUserPermissions && (currentUserPermissions.includes('Purchases_view')
                        || currentUserPermissions.includes('Purchases_add'))" @mouseenter="toggleSubMenu"
                        class="nav-item" :class="{ active: selectedParentMenu == 'purchases' }" data-item="purchases"
                        :data-submenu="true">
                        <a v-if="!isMobile" class="nav-item-hold" tag="a" href="/app/purchases/list">
                    ...
                    <li v-show="currentUserPermissions && (currentUserPermissions.includes('Sales_view')
                        || currentUserPermissions.includes('Sales_add')
                        || currentUserPermissions.includes('Pos_view')
                        || currentUserPermissions.includes('shipment'))" class="nav-item" @mouseenter="toggleSubMenu"
                        :class="{ active: selectedParentMenu == 'sales' }" data-item="sales" :data-submenu="true">
                        <a v-if="!isMobile" class="nav-item-hold" tag="a" href="/app/sales/list">
                    ...
                    <li v-if="currentUserPermissions && currentUserPermissions.includes('Sale_Returns_view')"
                        @mouseenter="toggleSubMenu" :class="{ active: selectedParentMenu == 'sale_return' }"
                        class="nav-item" data-item="sale_return">
                    ...
                    <li v-if="currentUserPermissions && currentUserPermissions.includes('Purchase_Returns_view')"
                        @mouseenter="toggleSubMenu" :class="{ active: selectedParentMenu == 'purchase_return' }"
                        class="nav-item" data-item="purchase_return">
                    ...
                    <li v-show="currentUserPermissions && (currentUserPermissions.includes('company')
                        ...
                        || currentUserPermissions.includes('holiday'))" @mouseenter="toggleSubMenu"
                        :class="{ active: selectedParentMenu == 'hrm' }" class="nav-item" data-item="hrm"
                        :data-submenu="true">
                    ...
                    <li v-show="currentUserPermissions && (currentUserPermissions.includes('transfer_view')
                        || currentUserPermissions.includes('transfer_add'))" @mouseenter="toggleSubMenu"
                        class="nav-item d-none" :class="{ active: selectedParentMenu == 'transfers' }"
                        data-item="transfers" :data-submenu="true">
                        <a class="nav-item-hold" href="#">
                            <i class="nav-icon i-Back"></i>
                    ...
                    <li v-show="currentUserPermissions && (currentUserPermissions.includes('expense_view')
                        || currentUserPermissions.includes('expense_add'))" @mouseenter="toggleSubMenu" class="nav-item"
                        :class="{ active: selectedParentMenu == 'expenses' }" data-item="expenses" :data-submenu="true">
                        <a class="nav-item-hold" href="#">
                    ...
                    <li v-show="currentUserPermissions && (currentUserPermissions.includes('Customers_view')
                        || currentUserPermissions.includes('Suppliers_view')
                        || currentUserPermissions.includes('users_view'))" @mouseenter="toggleSubMenu"
                        :class="{ active: selectedParentMenu == 'People' }" class="nav-item" data-item="People"
                        :data-submenu="true">
                        <a class="nav-item-hold" href="#">
                    ...
                    <li v-show="currentUserPermissions && (currentUserPermissions.includes('setting_system')
                        ...
                        || currentUserPermissions.includes('permissions_view'))" @mouseenter="toggleSubMenu"
                        :class="{ active: selectedParentMenu == 'settings' }" class="nav-item" data-item="settings"
                        :data-submenu="true">
                        <a class="nav-item-hold" href="#">
                    ...
                    <li v-show="currentUserPermissions &&
                        (currentUserPermissions.includes('Reports_payments_Sales')
                            ...
                            || currentUserPermissions.includes('stock_report'))" @mouseenter="toggleSubMenu"
                        :class="{ active: selectedParentMenu == 'reports' }" class="nav-item" data-item="reports"
                        :data-submenu="true">
                        <a class="nav-item-hold" href="#">
        ...
        <vue-perfect-scrollbar :class="{ open: getSideBarToggleProperties.isSecondarySideNavOpen }"
            ...
            <div ref="sidebarChild">
                <ul class="childNav d-none" data-parent="products"
                    ...
                    <li class="nav-item"
                        ...
                        <router-link tag="a" class to="/app/inventory/list">
                            <i class="nav-icon i-Check-2"></i>
                            <span class="item-name">{{ $t('CountStock') }}</span>
                        </router-link>
                    </li>
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('category')">
                    ...
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('brand')">
                        <router-link tag="a" class to="/app/products/Brands">
                            <i class="nav-icon i-Bookmark"></i>
                            <span class="item-name">{{ $t('Brand') }}</span>
                        </router-link>
                    </li>
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('unit')">
                ...
                <ul class="childNav d-none" data-parent="adjustments"
                ...
                <ul class="childNav d-none" data-parent="transfers"
                ...
                <ul class="childNav d-none" data-parent="stock_assignment"
                    :class="{ 'd-block': selectedParentMenu == 'stock_assignment' }">
                    <li class="nav-item"
                        v-if="currentUserPermissions && currentUserPermissions.includes('stock_assignment_add')">
                        <router-link tag="a" class to="/app/stock_assignment/store">
                            <i class="nav-icon i-Add-File"></i>
                            <span class="item-name">Créer un affectation de stock</span>
                        </router-link>
                    </li>
                    <li class="nav-item"
                        v-if="currentUserPermissions && currentUserPermissions.includes('stock_assignment_view')">
                        <router-link tag="a" class to="/app/stock_assignment/list">
                            <i class="nav-icon i-Files"></i>
                            <span class="item-name">Liste d'affectation des stocks</span>
                        </router-link>
                    </li>
                </ul>

                <ul class="childNav d-none" data-parent="expenses"
                ...
                <ul class="childNav d-none" data-parent="quotations"
                ...
                <ul class="childNav d-none" data-parent="purchases"
                    ...
                    <li class="nav-item"
                        ...
                        <router-link tag="a" class to="/app/purchases/new_purchase_return">
                            <i class="nav-icon i-Add-File"></i>
                            <span class="item-name">Ajouter un retour</span>
                        </router-link>
                    </li>
                    <li class="nav-item"
                        v-if="currentUserPermissions && currentUserPermissions.includes('Purchases_view')">
                        <router-link tag="a" class to="/app/purchases/purchases_payment">
                            <i class="nav-icon i-Credit-Card"></i>
                            <span class="item-name">Achats Paiements</span>
                        </router-link>
                    </li>
                </ul>

                <ul class="childNav d-none" data-parent="sales" :class="{ 'd-block': selectedParentMenu == 'sales' }">
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('Sales_add')">
                    ...
                    <li class="nav-item"
                        ...
                        <router-link tag="a" class to="/app/sales/new_sale_return">
                            <i class="nav-icon i-Add-File"></i>
                            <span class="item-name">Ajouter un retour</span>
                        </router-link>
                    </li>
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('Sales_view')">
                    ...
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('shipment')">
                ...
                <!-- hrm -->
                <ul class="childNav d-none" data-parent="hrm" :class="{ 'd-block': selectedParentMenu == 'hrm' }">
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('company')">
                        <router-link tag="a" class to="/app/hrm/company">
                            <i class="nav-icon i-Management"></i>
                            <span class="item-name">{{ $t('Company') }}</span>
                        </router-link>
                    </li>
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('department')">
                    ...
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('attendance')">
                        <router-link tag="a" class to="/app/hrm/attendance">
                            <i class="nav-icon i-Clock"></i>
                            <span class="item-name">{{ $t('Attendance') }}</span>
                        </router-link>
                    </li>
                    <li v-if="currentUserPermissions && (currentUserPermissions.includes('leave'))"
                        @click.prevent="toggleSidebarDropdwon($event)" class="nav-item dropdown-sidemenu">
                    ...
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('holiday')">
                ...
                <!-- People -->
                <ul class="childNav d-none" data-parent="People" :class="{ 'd-block': selectedParentMenu == 'People' }">
                    <li class="nav-item"
                    ...
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('users_view')">
                ...
                <ul class="childNav d-none" data-parent="settings"
                    ...
                    <!--<li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('warehouse')">-->
                    ...
                    <!--  </router-link>-->
                    <!--</li>-->
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('currency')">
                    ...
                    <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('backup')">
                ...
                <ul class="childNav d-none" data-parent="reports"
                    :class="{ 'd-block': selectedParentMenu == 'reports' }">
                    <li v-if="currentUserPermissions &&
                        (currentUserPermissions.includes('Reports_payments_Purchases')
                            || currentUserPermissions.includes('Reports_payments_Sales')
                            || currentUserPermissions.includes('Reports_payments_Sale_Returns')
                            || currentUserPermissions.includes('Reports_payments_purchase_Return'))"
        ...
        <div @click="removeOverlay()" class="sidebar-overlay"
