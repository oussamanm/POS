...
Route::middleware(['auth:api', 'Is_Active'])->group(function () {
    ...
    Route::post('change_password', 'PasswordResetController@change_password');
    ...
    Route::get('/app/getStatistic/{id_user}', 'ReportController@getStatistic');
    Route::get('/app/getVendeurs', 'UserController@getVendeurs');
    Route::get('app/clients', 'ClientController@app_index');
    Route::get('app/clients_credit', 'ClientController@client_credit');
    Route::post('app/clients/updateLocation', 'ClientController@update_location');
    Route::get('app/clients_details/{id}', 'ClientController@app_show');
    Route::put('app/clients/{id}', 'ClientController@update_app');
    Route::get('app/sales', 'SalesController@app_index');
    Route::get('app/show/{id}', 'SalesController@app_show');
    Route::post('app/sales', 'SalesController@app_store');
    Route::get('app/sales/destroy/{id}', 'SalesController@app_destroy');
    Route::post('app/sales/app_update/{id}', 'SalesController@app_update');
    Route::get('app/products', 'ProductsController@app_index');
    Route::get('app/get_warehoues', 'ProductsController@get_warehoues');
    Route::get('app/get_all_warehoues', 'ProductsController@get_all_warehoues');
    Route::get('app/products_warehouse', 'ProductsController@products_warehouse');
    Route::get('app/products_return', 'ProductsController@products_return');

    Route::get('app/stock_depot', 'ProductsController@products_warehouse_depot');
    Route::get('app/products_warehouse_exchange', 'ProductsController@products_warehouse_exchange');
    Route::get('app/products/filter', 'ProductsController@get_filter_product');
    Route::get('app/returns/filter/{id_client}', 'ProductsController@get_filter_returns');
    Route::get('app/transfers', 'TransferController@app_index');
    Route::get('app/print_invoice/{id}', 'SalesController@app_Print_Invoice_POS');

    Route::get('app/payments_by_user', 'PaymentSalesController@get_payment_by_user');
    Route::get('app/payments_by_ref', 'PaymentSalesController@get_payment_by_ref');

    Route::post('app/clients_pay_due', 'ClientController@app_clients_pay_due');

    Route::get('app/returns/sale', 'SalesReturnController@app_index');
    Route::get('app/returns/show/{id}', 'SalesReturnController@app_show');
    Route::post('app/returns', 'SalesReturnController@app_store');
    ...
    Route::get("report/payments_vendeur", "PaymentSalesController@payments_vendeur");
    Route::post("report/recieved_payments", "PaymentSalesController@recieved_payments");
    ...
    Route::get("get_employees", "hrm\EmployeesController@Get_employees");
    ...
    Route::get('get_products_return', 'ProductsController@get_products_return');
    ...
    Route::get('all_purchase_payments', 'PurchasesController@All_Payments');
